...
if st.button("Gerar Relatório PDF"):
    ...
    if not nomePaciente:
        ...
        canva_texto.drawString(38, 562, f"Data: {municipioUF}")
        canva_texto.drawString(38, 530, f"Data: {sintomasClin}")
        canva_texto.drawString(38, 420, f"Data: {justificativa}")
        canva_texto.drawString(38, 370, f"Data: {exames}")
        canva_texto.drawString(38, 318, f"Data: {diagInicial}")
        canva_texto.drawString(270, 318, f"Data: {cid}")
        canva_texto.drawString(330, 318, f"Data: {cidSecundario}")
        canva_texto.drawString(38, 282, f"Data: {procedimento}")
        canva_texto.drawString(38, 227, f"Data: {nomeMedico}")
        canva_texto.drawString(300, 227, f"Data: {data}")
        canva_texto.drawString(302, 250, f"Data: {cpfMedico}")        
        canva_texto.drawString(300, 325, f"Data: {CRM_Medico}")
